...
let friendsName:string[] = ["kashif", "akhtar", "israr", "nasir"]
...
let transportMode:string[] = ["Train", "Bus", "Truck", "Motorcycle"];
for (let index = 0; index < transportMode.length; index++) {
    let print:string = `I would like to own a ${transportMode[index]}.`;
    console.log(print);
