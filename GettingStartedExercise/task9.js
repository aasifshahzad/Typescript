...
let guestList = ["asif", "saqib", "sadiq", "wasif"];
let myaddress = "Camp Town, Florida";
for (let index = 0; index < guestList.length; index++) {
    let print = `Sir, ${guestList[index].toUpperCase()} you are invited to dinner on 23 August. Venue would be ${myaddress}.`;
    console.log(print);
}
